...
const pluginsSettingsTable = BEM(styles);

export const PluginsSettingsTable = withRouter(
...
const NameColumn = pluginsSettingsTable.nameColumn('div');
const StatusColumn = pluginsSettingsTable.statusColumn('div');
