...
interface Props extends RouteComponentProps<{ serviceGroupId: string; pluginId: string }> {
  className?: string;
  summaries?: Summary[];
  aggregatedData?: {
    coverage?: number;
...
export const TestToCodePlugin = withRouter(
  testToCodePlugin(
    ({
      className,
      history: { push },
      ...
      aggregatedData,
      match: {
        params: { serviceGroupId, pluginId },
      },
    }: Props) => {
